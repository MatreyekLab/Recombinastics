...
c2_none_raw <- read.csv(file = "data/flow/201002/Clone2_none.csv")
...
c2_recomb_raw <- read.csv(file = "data/flow/201002/Clone2_recomb.csv")
...
c2_ap1903_raw <- read.csv(file = "data/flow/201002/Clone2_ap1903.csv")
...
```{r Diving into clone2 data}
c6_none_raw <- read.csv(file = "data/flow/201002/Clone6_none.csv")
...
c6_recomb_raw <- read.csv(file = "data/flow/201002/Clone6_recomb.csv")
...
c6_ap1903_raw <- read.csv(file = "data/flow/201002/Clone6_ap1903.csv")
...
c11_none_raw <- read.csv(file = "data/flow/201002/Clone11_none.csv")
...
c11_recomb_raw <- read.csv(file = "data/flow/201002/Clone11_recomb.csv")
...
c11_ap1903_raw <- read.csv(file = "data/flow/201002/Clone11_ap1903.csv")
...
```{r Diving into clone2 data}
c2_none_raw <- read.csv(file = "data/flow/201016/Clone2_none.csv")
c2_none <- c2_none_raw[,c("FSC.A","SSC.A","VL1.A","BL1.A","YL2.A","RL1.A")]; colnames(c2_none) <- c("fsc","ssc","blu","grn","red","nir")
c2_none$clone <- "c2"; c2_none$treatment <- "none"
c2_recomb_raw <- read.csv(file = "data/flow/201016/Clone2_recomb.csv")
c2_recomb <- c2_recomb_raw[,c("FSC.A","SSC.A","VL1.A","BL1.A","YL2.A","RL1.A")]; colnames(c2_recomb) <- c("fsc","ssc","blu","grn","red","nir")
c2_recomb$clone <- "c2"; c2_recomb$treatment <- "recomb"
c2_ap1903_raw <- read.csv(file = "data/flow/201016/Clone2_ap1903.csv")
c2_ap1903 <- c2_ap1903_raw[,c("FSC.A","SSC.A","VL1.A","BL1.A","YL2.A","RL1.A")]; colnames(c2_ap1903) <- c("fsc","ssc","blu","grn","red","nir")
c2_ap1903$clone <- "c2"; c2_ap1903$treatment <- "ap1903"
...
```{r Diving into clone2 data}
c6_none_raw <- read.csv(file = "data/flow/201016/Clone6_none.csv")
c6_none <- c6_none_raw[,c("FSC.A","SSC.A","VL1.A","BL1.A","YL2.A","RL1.A")]; colnames(c6_none) <- c("fsc","ssc","blu","grn","red","nir")
c6_none$clone <- "c6"; c6_none$treatment <- "none"
c6_recomb_raw <- read.csv(file = "data/flow/201016/Clone6_recomb.csv")
c6_recomb <- c6_recomb_raw[,c("FSC.A","SSC.A","VL1.A","BL1.A","YL2.A","RL1.A")]; colnames(c6_recomb) <- c("fsc","ssc","blu","grn","red","nir")
c6_recomb$clone <- "c6"; c6_recomb$treatment <- "recomb"
c6_ap1903_raw <- read.csv(file = "data/flow/201016/Clone6_ap1903.csv")
c6_ap1903 <- c6_ap1903_raw[,c("FSC.A","SSC.A","VL1.A","BL1.A","YL2.A","RL1.A")]; colnames(c6_ap1903) <- c("fsc","ssc","blu","grn","red","nir")
c6_ap1903$clone <- "c6"; c6_ap1903$treatment <- "ap1903"
...
```{r Diving into clone11 data}
c11_none_raw <- read.csv(file = "data/flow/201016/Clone11_none.csv")
c11_none <- c11_none_raw[,c("FSC.A","SSC.A","VL1.A","BL1.A","YL2.A","RL1.A")]; colnames(c11_none) <- c("fsc","ssc","blu","grn","red","nir")
c11_none$clone <- "c11"; c11_none$treatment <- "none"
c11_recomb_raw <- read.csv(file = "data/flow/201016/Clone11_recomb.csv")
c11_recomb <- c11_recomb_raw[,c("FSC.A","SSC.A","VL1.A","BL1.A","YL2.A","RL1.A")]; colnames(c11_recomb) <- c("fsc","ssc","blu","grn","red","nir")
c11_recomb$clone <- "c11"; c11_recomb$treatment <- "recomb"
c11_ap1903_raw <- read.csv(file = "data/flow/201016/Clone11_ap1903.csv")
c11_ap1903 <- c11_ap1903_raw[,c("FSC.A","SSC.A","VL1.A","BL1.A","YL2.A","RL1.A")]; colnames(c11_ap1903) <- c("fsc","ssc","blu","grn","red","nir")
c11_ap1903$clone <- "c11"; c11_ap1903$treatment <- "ap1903"
...
## Cell densities correspond to 1.66e6 for "3", 5.25e5 for "2", and 1.66e5 for "1"
opt1 <- read.csv(file = "data/flow/201106/1_dense_500.csv", header = T) %>% mutate(density = 3, speed = 500)
opt2 <- read.csv(file = "data/flow/201106/2_dense_200.csv", header = T) %>% mutate(density = 3, speed = 200)
opt3 <- read.csv(file = "data/flow/201106/3_dense_100.csv", header = T) %>% mutate(density = 3, speed = 100)
opt4 <- read.csv(file = "data/flow/201106/4_med_500.csv", header = T) %>% mutate(density = 2, speed = 500)
opt5 <- read.csv(file = "data/flow/201106/5_med_200.csv", header = T) %>% mutate(density = 2, speed = 200)
opt6 <- read.csv(file = "data/flow/201106/6_med_100.csv", header = T) %>% mutate(density = 2, speed = 100)
opt7 <- read.csv(file = "data/flow/201106/7_sparse_500.csv", header = T) %>% mutate(density = 1, speed = 500)
opt8 <- read.csv(file = "data/flow/201106/8_sparse_200.csv", header = T) %>% mutate(density = 1, speed = 200)
opt9 <- read.csv(file = "data/flow/201106/9_sparse_100.csv", header = T) %>% mutate(density = 1, speed = 100)
...
ggplot() + theme_bw() + scale_x_log10() + labs(x = "BFP fluoresence", y = "Plots are different cell densities", color = "Speed") + 
  geom_density(data = opt_comb, aes(x = BL1.A, color = speed), adjust = 1/3) + facet_grid(rows =  vars(density))

ggplot() + theme_bw() + scale_x_log10() + labs(x = "BFP fluoresence", y = "Plots are different acquisition speeds", color = "Cell density") + 
