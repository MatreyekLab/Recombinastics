...
## f280
f280_g718a <- read.csv(file = "data/flow/Flanking/F280_G718A unselected.csv") %>% mutate("flow" = "f280", sample = "Flanked")
f280_g747a <- read.csv(file = "data/flow/Flanking/F280_G747A_unselected.csv") %>% mutate("flow" = "f280", sample = "Control")
flank_expt_cell_num <- 180000
flank_red_pos_cutoff <- 3e3
