...
vif_apobec_heatmap <- ggplot() + theme(axis.text.x.bottom = element_text(angle = 45, hjust = 1, vjust = 1)) +
...
vif_apobec_heatmap
ggsave(file = "Plots/Vif_apobec_heatmap.pdf", vif_apobec_heatmap, height = 2, width = 3.5)
```
